-- Add city and phone columns to company_profiles table
ALTER TABLE public.company_profiles ADD COLUMN IF NOT EXISTS city text;
ALTER TABLE public.company_profiles ADD COLUMN IF NOT EXISTS phone text;
...
BEGIN
  ...
  -- Insert into company_profiles if company (now including city and phone!)
